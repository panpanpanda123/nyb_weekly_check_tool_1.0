...
function setupEventListeners() {
    ...
    // 历史记录查询按钮
    document.getElementById('historyQueryBtn').addEventListener('click', () => {
        showStoreHistoryDialog();
    });    
    // 搜索按钮
...
function showStoreHistoryDialog() {
    ...
    `;
    document.body.appendChild(overlay);
    document.getElementById('historyKeyword').focus();
    document.getElementById('historyKeyword').addEventListener('keypress', e => {
        if (e.key === 'Enter') queryStoreHistory();
    });
}
